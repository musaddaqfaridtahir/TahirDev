...
import { ArrowRight, Terminal, Globe, ShieldCheck, ShoppingBag, Monitor } from "lucide-react";
...
const musaddaqStack = {
  ...
  const highlights = [
    { title: "Retail E-Commerce Engines", desc: "Next.js online stores with custom monthly installment calculators and order checkout.", icon: ShoppingBag },
    { title: "Offline Desktop POS Software", desc: "100% offline Electron.js + SQLite applications for local store ledgers and thermal printing.", icon: Monitor },
    { title: "Full-Stack Web Applications", desc: "Custom web portals, fleet dispatch tools, and database management systems built for scale.", icon: Globe },
  ];

  return (
    <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden bg-[#0B0F17] border-b border-slate-800/80">
      
      {/* Subtle Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[280px] bg-cyan-500/10 blur-[130px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-md bg-slate-900 border border-emerald-500/30 text-emerald-400 text-xs font-mono mb-6">
              ...
              <span>Available for Contract Engineering</span>
            </div>

            <h1 className="text-3xl sm:text-5xl lg:text-5xl font-extrabold text-white tracking-tight leading-[1.15] mb-4">
              Full-Stack Next.js Developer &amp; <br className="hidden sm:inline" />
              <span className="text-cyan-400">Custom Software Engineer</span>
            </h1>

            {/* VS Code Compact Typing Pill */}
            <div className="mb-6">
            ...
            <div className="flex flex-wrap items-center gap-3.5 w-full sm:w-auto">
              ...
              <Link
                href="/contact"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-200 hover:text-white font-semibold text-xs transition-all"
              >
          ...
          <div className="lg:col-span-5 w-full">
            <div className="relative rounded-2xl bg-slate-950 border border-slate-800 shadow-2xl overflow-hidden">
              ...
              <div className="p-4 font-mono text-[11px] overflow-x-auto min-h-[180px]">
        ...
        {/* Highlights Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10 border-t border-slate-800/80 mt-10">
